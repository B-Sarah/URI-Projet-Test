...
public final class CommonUtil
{
  ...
  static
  {
    ...
    {
      CommonPlugin.INSTANCE.log(throwable);
  ...
  static final class StringPool extends Pool<String>
  {
      ...
      public String match()
      {
        ...
        if (toLowerCase != null)
        {
          ...
          if (toLowerCase == Boolean.TRUE)
          {
            ...
            if (lowerCaseString.equals(result))
            {
          ...
          else
          {
            ...
            if (upperCaseString.equals(result))
            {
     ...
     */
    protected String intern(CharSequence charSequence)
    {
     ...
     */
    protected String javaIntern(String string)
    {
      // Retrieve an access unit for exclusive use in this call for the current thread thread.
      //
